...
export default {
  ...
  methods: { // "methods" is an object of functions that the webpage can/will run
    search() { // Could be used to search a table by sending a post request
      ...
      axios
        .post("http://localhost:9001/genres/search", {search: this.searchForm, edited: this.searchEdited, empty: this.emptyForm})
        .then((response) => {
    ...
    insert() { // Could be used to insert into the table using a put request
      ...
      axios
        .post("http://localhost:9001/genres/insert", {insert: this.insertForm})
        .then((response) => {
            console.log(response)
        })
        .catch((error) => {
    ...
    edit() { // Could be used to edit a table entry using a post request
        ...
        axios
          .post("http://localhost:9001/genres/edit", {edit: this.editObject})
          .then((response) => {
              console.log(response)
          })
          .catch((error) => {
    ...
    confirmDelete() { // Could be used to delete a table entry using a delete request
        ...
        axios
          .delete("http://localhost:9001/genres/delete", {data: {genre_name: this.deleteObject.genre_name}})
          .then((response) => {
              console.log(response);
              this.search();
          })
