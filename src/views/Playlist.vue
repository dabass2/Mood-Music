...
export default {
  ...
  methods: {
    ...
    confirmCreate() {
      ...
      axios
        .post("http://localhost:9001/playlist/create", {userId: this.userId, name: this.newTitle})
        .then((response) => {
    ...
    deleteSong(song) {
      // console.log(song)
      axios
        .post("http://localhost:9001/playlist/song/delete", {playlistId: this.id, songId: song.song_id})
        .then((response) => {
            console.log(response)
    ...
    confirmDelete() {
      ...
      console.log(this.id)
      axios
        .post("http://localhost:9001/playlist/delete", {id: this.id})
        .then((response) => {
            console.log(response)
            this.$router.go()
        })
    ...
    getSongs(idx) {
      ...
      axios
        .post("http://localhost:9001/playlist/songs", {id: this.id})
        .then((response) => {
            // console.log(response.data.results)-
            axios
              .post("http://localhost:9001/playlist/stats", {id: this.id})
              .then((res) => {
