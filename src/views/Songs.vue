...
export default {
  ...
  methods: { // "methods" is an object of functions that the webpage can/will run
    search() { // Could be used to search a table by sending a post request
      ...
      axios
        .post("http://localhost:9001/songs/search", {search: this.searchForm, edited: this.searchEdited, empty: this.emptyForm})
        .then((response) => {
    ...
    insert() { // Could be used to insert into the table using a put request
      ...
      axios
        .post("http://localhost:9001/songs/insert", {insert: this.insertForm})
        .then((response) => {
            console.log(response)
        })
        .catch((error) => {
    ...
    edit() { // Used to edit a table entry using a post request
        ...
        axios
          .post("http://localhost:9001/songs/edit", {edit: this.editObject})
          .then((response) => {
              console.log(response)
          })
          .catch((error) => {
    ...
    confirmDelete() { // Used to delete a table entry using a delete request
        ...
        axios
          .delete("http://localhost:9001/songs/delete", {data: {song_id: this.deleteObject.song_id, song_name: this.deleteObject.song_name}})
          .then((response) => {
              console.log(response);
              this.search()
          })
